...
package com.example.android.go_market.core.persistence;
...
import com.example.android.go_market.features.auth.login.data.UserDao;
import com.example.android.go_market.features.auth.login.domain.entities.UserModel;
import com.example.android.go_market.features.detail_shop.data.ShopDao;
